class Heat {
  ...
  static List<Heat> get allHeats => [
    ...
    Heat(
      ...
      equipos: [
        Team(id: 4, idHeat: 2, nombre: 'Las Despist-hadas'),
        Team(id: 5, idHeat: 2, nombre: 'Las 30&Fuertes'),
        Team(id: 6, idHeat: 2, nombre: 'Máquinas Primerizas'),
      ],
    ),
    Heat(
      id: 3, nombre: 'Heat 3', categoria: 'Duplas Hombres Amateur', horaInicio: '10:00',
      equipos: [
        Team(id: 7, idHeat: 3, nombre: 'Pinky y Cerebro'),
        Team(id: 8, idHeat: 3, nombre: 'Team CMT'),
        Team(id: 9, idHeat: 3, nombre: 'Los Hermanos Torres'),
        Team(id: 10, idHeat: 3, nombre: 'Mix Meta'),
        Team(id: 11, idHeat: 3, nombre: 'Team Eleven'),
      ],
    ),
    Heat(
      id: 4, nombre: 'Heat 4', categoria: 'Individual Hombres Pro', horaInicio: '12:00',
      equipos: [
        Team(id: 12, idHeat: 4, nombre: 'Reinaldo Cuevas Nazal'),
        Team(id: 13, idHeat: 4, nombre: 'Cristian Miranda Simpson'),
        Team(id: 14, idHeat: 4, nombre: 'Roberto Ortega Ortega'),
      ],
    ),
    Heat(
      id: 5, nombre: 'Heat 5', categoria: 'Duplas Mixtas Amateur', horaInicio: '14:00',
      equipos: [
        Team(id: 15, idHeat: 5, nombre: 'Studio Indómito'),
        Team(id: 16, idHeat: 5, nombre: 'Mix Meta Junior'),
        Team(id: 17, idHeat: 5, nombre: 'Pulso Indomallku'),
        Team(id: 18, idHeat: 5, nombre: 'Gene y Pato'),
      ],
    ),
    Heat(
      id: 6, nombre: 'Heat 6', categoria: 'Duplas Mixtas Amateur', horaInicio: '14:30',
      equipos: [
        Team(id: 19, idHeat: 6, nombre: 'No Runners'),
        Team(id: 20, idHeat: 6, nombre: 'Mix Meta'),
        Team(id: 21, idHeat: 6, nombre: '40/20'),
      ],
    ),
  ];
}
