  ...
  static List<Heat> get allHeats => [
    ...
    Heat(
      ...
      equipos: [
        ...
        Team(id: 6,  idHeat: 2, nombre: 'Bárbara y Nicol'),
    ...
    Heat(
      ...
      equipos: [
        Team(id: 13, idHeat: 4, nombre: 'Reinaldo Cuevas Nazal'),
        Team(id: 14, idHeat: 4, nombre: 'Cristian Miranda Simpson'),
        Team(id: 15, idHeat: 4, nombre: 'Roberto Ortega Ortega'),
      ],
    ),
    Heat(
      id: 5, nombre: 'Heat 5', categoria: 'Duplas Mixtas Amateur', horaInicio: '14:00',
      equipos: [
        Team(id: 16, idHeat: 5, nombre: 'Studio Indómito'),
        Team(id: 17, idHeat: 5, nombre: 'Mix Meta Junior'),
        Team(id: 18, idHeat: 5, nombre: 'Pulso Indomallku'),
        Team(id: 19, idHeat: 5, nombre: 'Gene y Pato'),
      ],
    ),
    Heat(
      id: 6, nombre: 'Heat 6', categoria: 'Duplas Mixtas Amateur', horaInicio: '14:30',
      equipos: [
        Team(id: 20, idHeat: 6, nombre: 'No Runners'),
        Team(id: 21, idHeat: 6, nombre: 'Mix Meta'),
        Team(id: 22, idHeat: 6, nombre: '40/20'),
      ],
    ),
  ];
}
